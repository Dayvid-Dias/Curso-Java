...
public class AulaDoisExSeis {
    ...
    public static void main(String[] args) {
        ...
        double precoOriginal = 3000;
        double percentualDesconto = 10;
        double valorDesconto = (percentualDesconto/100) * precoOriginal;
        double precoComDesconto = precoOriginal - valorDesconto;

        System.out.printf("O preço original do produto é de R$%.2f, que com desconto de 10%% foi para" +
                "R$%.2f.", precoOriginal, precoComDesconto);
