...
* Para isso, o sistema deve calcular a data exata em que um lembrete de
* pagamento deve ser disparado com base no prazo de antecedência definido.
...
public class ExSeis {
    public static void main(String[] args) {
        ...
        if (dataVencimento.getDayOfMonth() <= 20){
            notificacao = 10;
        } else{
            notificacao = 5;
        }

        LocalDate dataNotificacao = dataVencimento.minusDays(notificacao);

        System.out.println("Data do lembrete: " + dataNotificacao.format(formatter));
